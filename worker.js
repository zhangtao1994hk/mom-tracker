        ...
        <head>
            ...
            <style>
                ...
                .tag { 
                    ...
                    -webkit-user-select: none; /* 防止长按弹出系统菜单 */
                }
                ...
                /* 提示气泡基础样式 */
                .tag::after {
                    content: attr(data-tip); /* 从 data-tip 属性读取文字 */
                    position: absolute;
                ...
                .tag::before {
                    ...
                    border: 6px solid transparent; border-top-color: rgba(0, 0, 0, 0.8);
                ...
                /* 手机端：点击/长按显示 */
                .tag:active::after, .tag:active::before {
                    visibility: visible; opacity: 1;
                }
            </style>
        </head>
            ...
            <script>
                ...
                async function fetchLocation() {
                    try {
                        ...
                        const timeVal = (data.time.includes(' ') ? data.time.split(' ')[1] : data.time);
                        document.getElementById('time-tag').innerText = "🕒 " + timeVal;
                        document.getElementById('time-tag').setAttribute('data-tip', "上报时间：" + data.time);
